...
- Evidence for two separate QTL affecting three behavioral traits in a 3 cM region        
- Shared methods in an R package, `qtl2pleio` https://github.com/fboehm/qtl2pleio    


## Introduction

- Experimentalists measure thousands of phenotypes with RNA sequencing and mass spectrometry    
...
- @logan2013high and @recla2014precise genotyped and phenotyped 261 Diversity Outbred mice    
    ...
    - Identified Chr 8 QTLs for "percent time in light" and "distance traveled in light" at 55 cM    
